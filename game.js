...
const CUTSCENES={
  ...
  rand:[{image:'assets/cs-rand.jpg',kicker:'ENCRYPTED TRANSMISSION · SOURCE UNKNOWN',title:'SOMEONE ABOARD IS LYING',speaker:'DISTORTED VOICE',text:'Your flight plan was filed before the dogs were taken. The enemy did not find your route. He bought it.',motion:'snap',accent:'blue',cue:'signal'}],
  liveDogs:[{image:'assets/cs-dogs-reactor-v2.jpg',kicker:'HIJACKED CAMPUS SIGNAL',title:'FIVE HEARTBEATS',speaker:'HOPPE // REMOTE SIGNAL',text:'All five are alive. The countdown just lost an hour. Javier, whatever you hit, hit it faster.',motion:'push',accent:'red',cue:'heartbeat'}],
  betrayal:[
    ...
    {image:'assets/cs-stalin-statue.jpg',kicker:'MOSCOW · SECURE CHANNEL',title:'HOPPE CHOSE HIS FUTURE',speaker:'STALIN',text:'He opened the road. You supplied the rage. History supplied the trap.',motion:'drop',accent:'red',cue:'threat'}
  ],
  kennel:[{image:'assets/cs-dogs-reactor-v2.jpg',kicker:'ABOVE THE CORE · LOCKDOWN',title:'FIVE PAWS HIT THE GLASS',speaker:'MILEI',text:'I am here. Hold on.',motion:'push',accent:'red',cue:'heartbeat'}],
  marx:[{image:'assets/cs-marx-dissolves.jpg',kicker:'THE REACTOR OPENS',title:'THE MACHINE NEEDS A GHOST',speaker:'SUPER STALIN',text:'Steel remembers what flesh forgets.',motion:'shake',accent:'red',cue:'reveal'}],
  smith:[{image:'assets/cs-smith.jpg',kicker:'THE FREE PORT · BETWEEN YEARS',title:'DOLLARIZATION SHOP',speaker:'ADAM SMITH',text:'Spend what you saved. Save what matters. Never hold a melting peso.',motion:'pan-left',accent:'blue',cue:'shop'}],
  homecoming:[{image:'assets/cs-homecoming-v2.jpg',kicker:'CASA ROSADA · SUNRISE',title:'THEY KNOW HIS FOOTSTEPS',speaker:'MILEI',text:'Easy. Easy! I missed you too.',motion:'pan-right',accent:'blue',cue:'victory'}],
  postCredits:[
