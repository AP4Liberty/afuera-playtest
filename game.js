...
const state = { running:false,paused:false,muted:false,runId:0,level:1,time:0,hitStop:0,camera:0, wave:0, wavePending:false,waveDelay:0,waveStartTime:0,waveStartHp:100,waveStartDodges:0,waveMaxCombo:0,waveObjective:null,waveGrade:'',waveGradeTime:0,tip:'',tipTime:0, scene:0,sceneFade:0,phaseFlash:0,musicNext:0,musicNote:0,musicBoss:false,score:0,multiplier:1, pesos:0, meter:0, shake:0, banner:'CALLE CORRIENTES', bannerTime:3,bossQuote:'',bossQuoteTime:0,bossMove:'',bossMoveTime:0,enemies:[],defeats:[],pickups:[], particles:[], projectiles:[],popups:[],props:[],hazards:[],stats:freshStats(),perf:freshPerf(), boss:false, victory:false };
...
function drawHud(){
  ...
  if(state.tipTime>0){const tipY=matchMedia('(pointer:coarse), (max-width:800px)').matches?130:H-92,transmission=/^(HOPPE|RAND|DOG SIGNAL):/.test(state.tip);ctx.globalAlpha=clamp(state.tipTime,0,1);ctx.fillStyle='#07172dea';ctx.fillRect(160,tipY,W-320,50);ctx.strokeStyle=transmission?'#e0ad3b':'#73c8e8';ctx.lineWidth=2;ctx.strokeRect(160,tipY,W-320,50);ctx.fillStyle=transmission?'#e0ad3b':'#73c8e8';ctx.font='10px Bungee';ctx.fillText(transmission?'STORY TRANSMISSION':'LIBERTY INTEL',175,tipY+20);ctx.fillStyle='#f1e2bd';ctx.font='bold 13px Chakra Petch';ctx.fillText(state.tip,175,tipY+39);ctx.globalAlpha=1}
